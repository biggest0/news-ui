		...
		<section className="py-6">
			...
			<div className="max-w-sm pt-6">
				...
				<button
					...
					className="w-full flex items-center justify-center gap-2 border border-border-subtle rounded-lg py-2 text-sm text-foreground-secondary hover:bg-muted transition-colors"
				>
