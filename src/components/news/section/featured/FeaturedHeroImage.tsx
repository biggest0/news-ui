 ...
 *
 * `ruled` is what both the desktop hero and the mobile section use; the other
 * two are kept as working alternates so the look can be switched from a single
 * default in `FeaturedSection` rather than rebuilt. Three further variants (a
 * scrim overlay, a grayscale newsprint treatment, and a quote-above-photo
 * display) were compared and dropped.
 */
