...
/**
 * Slide-in panel built on @base-ui/react Dialog (focus trap, Escape close,
 * aria-modal, scroll lock, focus return for free). Generated from the shadcn
 * registry and adapted to this app: react-icons instead of lucide, PascalCase
 * filename, Button import fixed to the renamed PascalCase module.
 */
