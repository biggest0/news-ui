...
export const AppTitle = ({ variant = "desktop" }: AppTitleProps) => {
	const tailwindClasses =
		variant === "desktop"
			...
			: "text-2xl font-semibold text-foreground tracking-wide";
		...
		<Link to={PAGE_ROUTES.HOME} className={tailwindClasses}>
			<span className="relative inline-block">
				...
				<img
					...
					alt=""
					className="absolute top-[52%] md:top-[54%] lg:top-[57%] left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 w-5 h-5 md:w-6 md:h-6 lg:w-9 lg:h-9 dark:invert dark:opacity-80"
				/>
			</span>
